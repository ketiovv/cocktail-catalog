 ...
 * Use the [FavouriteOwnDrinksFragment.newInstance] factory method to
...
class FavouriteOwnDrinksFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FavouriteOwnDrinksFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FavouriteOwnDrinksFragment().apply {
